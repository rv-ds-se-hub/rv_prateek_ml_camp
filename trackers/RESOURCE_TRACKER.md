...
This is our go-to library for all external books, articles, tools, and datasets we'll use throughout the course.

### 📘 Core Books

| Topic       | Title                                                                             | Author              | Link Useful                                            |
| :---------- | :-------------------------------------------------------------------------------- | :------------------ | :--------------------------------------------------------- |
| **Python** | *Learn Python the hard way* | Zed A. Shaw     | https://github.com/rvs-23/ds-de-se-hub/tree/main/10_programming/python/00_books |
